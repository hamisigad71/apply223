...
.csborder-color,.csborder-hovercolor:hover,.bottom-footer , .event-editor .socialmedia .add-calender , .share-btn , .text-background-right .text-button-plain:hover , .text-background-left  .text-button-plain:hover , .pricing-page .price-button .upgrate:hover , .fullbackground-gray  .get-enrole-button  .get-enrole:hover{
    border-color:#fec327 !important;
}
.events-minimal:hover,.widget.event-calendar .eventsCalendar-list-wrap,.cs-tabs.vertical .nav-tabs .active a:before {
    border-left-color:#fec327 !important;
}

.cs-blog-grid .owl-controls .owl-prev:hover,
.cs-blog-grid .owl-controls .owl-next:hover{
    border-top-color:#fec327 !important;
}

body,.main-section p {
	font:Normal  14px 'Oxygen', sans-serif;	 color:#00635e;
}
header .logo{
...
.main-section h1, .main-section h1 a {color: #00635e !important;}
.main-section h2, .main-section h2 a{color: #00635e !important;}
.main-section h3, .main-section h3 a{color: #00635e !important;}
.main-section h4, .main-section h4 a{color: #00635e !important;}
.main-section h5, .main-section h5 a{color: #00635e !important;}
.main-section h6, .main-section h6 a{color: #00635e !important;}
...
.logo-section,.main-head{background:none !important;}
/********/
...
.sub-dropdown { background-color:#ffe7b2 !important;}
.navigation > ul ul li > a {color:#00635e !important;}
.navigation > ul ul li:hover > a {color:#00635e;color:#00635e !important;}
.navigation > ul > li:hover > a {color:#00635e !important;}
.sub-dropdown:before {border-bottom:8px solid #00635e !important;}
.navigation > ul > li.parentIcon:hover > a:before { background-color:#00635e !important; }
.cs-user,.cs-user-login { border-color:#00635e !important; }
{
...
#footer-sec {
    background:url() #fec42f repeat scroll 0 0 / cover !important; 
 }
#footer-sec::before {
 background-color:rgba(254, 196, 47, 0.95) !important;;
 }
.footer-content {
    background-color:#fec42f !important;
}
...
#footer-sec .widget{
     background-color:background-color:rgba(254, 196, 47, 0.95) !important; !important;
}
